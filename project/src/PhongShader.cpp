...
{
    InvertBoolLoc = glGetUniformLocation(ShaderProgram, "InvertBool");
    AuraBoolLoc = glGetUniformLocation(ShaderProgram, "AuraBool");
    RimBoolLoc = glGetUniformLocation(ShaderProgram, "RimBool");
...
void PhongShader::activate(const BaseCamera& Cam) const
{
    ...
    glUniform1i(RimBoolLoc, RimBool);
    glUniform1i(AuraBoolLoc, AuraBool);
    glUniform1i(InvertBoolLoc, InvertBool);
...
void PhongShader::rimBool(bool b)
{
	RimBool = b;
}
void PhongShader::auraBool(bool b)
{
	AuraBool = b;
}
void PhongShader::invertBool(bool b)
{
	InvertBool = b;
}
